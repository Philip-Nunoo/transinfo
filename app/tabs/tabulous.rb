Tabulous.setup do
  ...
  tabs do
    ...
    congestions_tab do
      text          { 'Line View' }
      link_path     { dashboard_line_view_path }
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('line_view').of_controller('dashboard') }
    end

    locations_tab do
      text          { 'Map View' }
      link_path     { dashboard_map_view_path }
      visible_when  { true }
      enabled_when  { true }
    ...
    #   visible_when  { true }
    #   enabled_when  { true }
    #   active_when   { in_action('any').of_controller('dashboard') }
    # end
